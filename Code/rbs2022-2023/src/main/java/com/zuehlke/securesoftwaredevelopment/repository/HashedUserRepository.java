...
public class HashedUserRepository {
    ...
    public HashedUser findUser(String username) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            String opis = String.format("Pronalazak hesiranog korisnika sa kor. imenom: %s nije uspelo!", username);
            LOG.warn(opis);
        }
        return null;
    }
    ...
    public void saveTotpKey(String username, String totpKey) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            String opis = String.format("Cuvanje TOTP kljuca za korisnika sa kor. imenom: %s nije uspelo!", username);
            LOG.warn(opis);
        }
    }
}
