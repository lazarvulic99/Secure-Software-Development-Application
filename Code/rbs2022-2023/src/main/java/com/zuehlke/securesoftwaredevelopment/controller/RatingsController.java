...
public class RatingsController {
    ...
    public String createOrUpdateRating(@RequestBody Rating rating, Authentication authentication) {
        // Na html stranici ovo nece biti sakriveno, samo ce biti onemoguceno
        // Kako bih prikazao i drugi nacin koji je pokazan na vezbama
        // Umesto: sec:authorize="hasAuthority('RATE_MOVIE')"
        // Koristicu: th:disabled="${not #authorization.expression('hasAuthority(''RATE_MOVIE'')')}"
